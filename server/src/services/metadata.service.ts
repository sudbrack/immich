...
export class MetadataService extends BaseService {
  ...
  private getDates(asset: AssetEntity, exifTags: ImmichTags): AssetDatesDto {
    ...
    let dateTimeOriginal = dateTime?.toDate() ?? null;
    let localDateTime = dateTime?.toDateTime().setZone('UTC', { keepLocalTime: true }).toJSDate() ?? null;
  ...
  private earliestDate(a: Date, b: Date): Date {
